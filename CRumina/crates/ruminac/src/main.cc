...
int main(int argc, char* argv[]) {
    if (argc < 2) {
        std::cerr << "Usage: ruminac <input.lm> [output.lmc]\n";
        std::cerr << "  Compiles a .lm file to .lmc bytecode\n";
        std::cerr << "\n";
        std::cerr << "Examples:\n";
        std::cerr << "  ruminac test.lm           # Creates test.lmc\n";
        std::cerr << "  ruminac test.lm out.lmc   # Creates out.lmc\n";
        return 1;
    }
